    ...
    return (
        <div className="playfair-display my-12 flex justify-between items-center px-6 md:px-16 xl:px-28 py-6 md:py-12 xl:py-20 bg-[#1313130D] rounded-3xl">
            <div className="flex flex-col gap-4 md:gap-8 xl:gap-12">
                ...
                <Link className='work-sans bg-[#23BE0A] text-base md:text-xl font-semibold text-white border border-[#23BE0A] rounded-xl w-32 md:w-48 h-10 md:h-16 hover:bg-transparent hover:text-[#23BE0A] transition duration-500 flex justify-center items-center' to={'/listed-books'}>View The List</Link>
            </div>
