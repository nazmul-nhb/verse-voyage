    ...
    return (
        <section className="flex items-center h-full sm:p-16 dark:bg-gray-50 dark:text-gray-800">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-6 space-y-4 text-center">
                ...
                <Link to={'/'} rel="noopener noreferrer" href="#" className="px-8 py-3 font-semibold bg-[#59C6D2] text-white border border-[#59C6D2] rounded-xl hover:bg-white hover:text-[#59C6D2] transition duration-500">Back to homepage</Link>
            </div>
        </section>
    );
};
