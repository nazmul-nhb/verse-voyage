...
const About = () => {
    return (
        <div className="mx-6 my-4 md:my-12 flex flex-col items-center gap-6">
            <Helmet>
                <title>About Verse Voyage</title>
            </Helmet>
            <div className="w-full bg-[#1313130D] p-4 md:py-9 rounded-2xl flex justify-center items-center mb-6">
                <h3 id="about-header" className="text-2xl md:text-3xl font-bold">About Us</h3>
            </div>
            ...
            <p className="md:w-2/3 text-base md:text-xl mt-8 md:mt-16 text-center text-gray-500">
